...
//  EABlurView
//
//  Created by Meniny on 2015/04/08.
//  Copyright (c) 2017 Bushtit Lab. All rights reserved.
//

import UIKit

open class EABlurView: UIView {
...
extension EABlurView {
    private func linkForDisplay() {
        displayLink?.invalidate()
        displayLink = UIScreen.main.displayLink(withTarget: self, selector: #selector(EABlurView.displayDidRefresh(_:)))
